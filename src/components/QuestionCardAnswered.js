...
class QuestionCardAnswered extends React.Component {
    ...
    render () {
        ...
        return (<div>
            { Object.keys(question).length > 0 ? (<div><h2>Results: </h2>
                <AnsweredQuestionBar question={question.optionOne}
                                     countAnswers={countAnswers}
                                     additionalClass="greenAnswerCard"
                                     badge={myAnswer === 'optionOne'}/>
                <AnsweredQuestionBar question={question.optionTwo}
                                     countAnswers={countAnswers}
                                     additionalClass="grayAnswerCard"
                                     badge={myAnswer === 'optionTwo'}/></div>) : (<div></div>)}
        </div>);
    }
}
